function alpha_offsetAxes(ax,f)
...
%
% by Anne Urai, 2016
% Eugenio Abela: renamed for consistency, added f (size factor, integer).
% All credite to Anne and Pierre!

if ~exist('ax', 'var'), ax = gca; end

% modify the x and y limits to below the data (by a small amount)
ax.XLim(1) = ax.XLim(1)-(ax.XTick(2)-ax.XTick(1))/f;
ax.YLim(1) = ax.YLim(1)-(ax.YTick(2)-ax.YTick(1))/f;
